...
public:
    ...
    int legacy_to_quint_lane(Lane legacy_lane) const {
        switch (legacy_lane) {
            case Lane::L1_Fast:      return 0;  // 144 Hz
            case Lane::L2_Medium:    return 1;  // 288 Hz
            case Lane::L3_Slow:      return 2;  // 432 Hz
            case Lane::L4_VerySlow:  return 3;  // 576 Hz
            case Lane::L5_UltraSlow: return 4;  // 720 Hz
            default: return -1;
        }
    }
